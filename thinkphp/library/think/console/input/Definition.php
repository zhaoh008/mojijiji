...
class Definition
{
    ...
    public function addArgument(Argument $argument)
    {
        ...
        if ($this->hasAnArrayArgument) {
            throw new \LogicException('Cannot article an argument after an array argument.');
        }

        if ($argument->isRequired() && $this->hasOptional) {
            throw new \LogicException('Cannot article a required argument after an optional one.');
        }
