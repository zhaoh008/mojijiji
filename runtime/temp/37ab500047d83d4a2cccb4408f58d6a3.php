            ...
            <main class="col-md-8 " >
                ...
                <article class="post" >
                    <div class="post-head " >
                        ...
                        <div class="post-meta" >
                            <sapn class="author">
                                作者：<a style="color: #ff6766" href="#" ><?php echo $vo['author']; ?></a>
                            </sapn>
                            ·
                    ...
                    <div class="post-content" >
                        <p></p>
                        <p><?php echo html_entity_decode($vo['content']); ?></p>
                        <p></p>
                    </div>
                ...
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <div class="page-doc " >
                    <?php if(is_array($prev) || $prev instanceof \think\Collection || $prev instanceof \think\Paginator): $i = 0; $__LIST__ = $prev;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <a href="<?php echo url('index/index/seeArticle',['article_id'=>$vo['article_id']]); ?>" class="btn btn-doc1"><span class="glyphicon glyphicon-chevron-left  " ></span>
                        <?php echo $vo['title']; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; if(is_array($next) || $next instanceof \think\Collection || $next instanceof \think\Paginator): $i = 0; $__LIST__ = $next;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <a href="<?php echo url('index/index/seeArticle',['article_id'=>$vo['article_id']]); ?>" class="btn btn-doc1">
                        <?php echo $vo['title']; ?>
