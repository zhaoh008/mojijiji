<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"C:\wamp64\www\mojijiji\public/../application/admin\view\wellsaying\wellsaying.html";i:1555384342;s:71:"C:\wamp64\www\mojijiji\public/../application/admin\view\index\head.html";i:1555384342;s:73:"C:\wamp64\www\mojijiji\public/../application/admin\view\index\header.html";i:1555384342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-md-12 " >
                <div class="post ">
                    ...
                    <div class="post-content" >
                        <form class="form-inline" role="form" method="post" action="<?php echo url('wellsaying/findwellsaying'); ?>">
                            <div class="form-group">
                                <label  for="name">名言内容:</label>
                                <input type="text" class="form-control form-control2" id="name" placeholder="请输入关键字" name="content">
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered">
                                ...
                                <tr> <td><a data-toggle="modal" data-target="#myModal<?php echo $vo['id']; ?>"><span class="glyphicon glyphicon-tags">修改</span></a>&nbsp;
                                    <div class="modal " style="margin-top: 100px" id="myModal<?php echo $vo['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLab">修改名言</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                </div>
                                                <form method="post" style="margin-top: 10px" action="<?php echo url('wellsaying/updwellsaying',['id'=>$vo['id']]); ?>" role="form">


                                                        <textarea type="text" rows="4" style="width: 100%" class="form-control form-control1"  id="title1" name="content" ><?php echo $vo['content']; ?></textarea>
                                    ...
                                    <a data-toggle="modal" data-target="#myModa<?php echo $vo['id']; ?>"><span class="glyphicon glyphicon-trash">删除</span></a></td>
                                    <div class="modal " style="margin-top: 100px" id="myModa<?php echo $vo['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                                                    <a href="<?php echo url('wellsaying/delwellsaying',['id'=>$vo['id']]); ?>" class="btn btn-doc1">确定</a>
                                                </div>
                                            </div><!-- /.modal-content -->
                                        </div><!-- /.modal -->
                                    </div>
                    ...
                    <div class="page-doc" >
                    <?php echo $wellsaying->render(); ?>
                </div>

                    <div class="post-permalink">
                        <a data-toggle="modal" data-target="#myModal1" class="btn btn-doc1">添加名言</a>
                        <div class="modal " style="margin-top: 100px" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">添加名言</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    </div>
                                    <form method="post" style="margin-top: 10px" action="<?php echo url('wellsaying/savewellsaying'); ?>" role="form">

                                            <label for="title" class="">名言内容：</label>
                                        <textarea type="text" rows="4" style="width: 100%" class="form-control form-control1"  id="title" name="content" placeholder="请名言内容，包含作者"></textarea>
